package demo.application.backend.infra.logs;
...
public class Logger {
    ...
    public void info(String action, Object info, String... actionArgs) throws Exception {
    ...
    public void error(String action, String message, Object info, String... actionArgs) throws Exception {
        StackTraceElement ste = Thread.currentThread().getStackTrace()[2];
        int l = ste.getLineNumber();
        String a = ste.getClassName(),
                c = ste.getMethodName(),
