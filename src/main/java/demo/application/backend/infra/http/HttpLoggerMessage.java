package demo.application.backend.infra.http;

import demo.application.backend.utils.json.Util_Json;
import lombok.Data;
...
public class HttpLoggerMessage {
    ...
    public HttpLoggerMessage(String appMode, String transaction, String action, String url, String method, String authorization, ContentType contentType, String payload, StatusLine statusLine, Object response, long duration) throws Exception {
        super();
