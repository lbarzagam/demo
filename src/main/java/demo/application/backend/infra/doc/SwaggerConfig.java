package demo.application.backend.infra.doc;


import demo.application.backend.infra.http.SwaggerPage;
import demo.application.backend.infra.http.SwaggerPageable;
...
public class SwaggerConfig {
    ...
    public static final Contact DEFAULT_CONTACT = new Contact(
            "Lorenzo Bárzaga", "https://thecsf.atlassian.net/jira/people/5fa15fb58573800069b6cdca", "lbarzagam11@gmail.com");
